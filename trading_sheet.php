...
if(isset($_POST['submit'])){
	...
	$sql = 'insert into invoice_trading_account (entry_date, user_id) values ("'.date("Y-m-d H:i:s").'", "'.$_SESSION['usersno'].'")';
	execute_query($sql);
	...
	while($row = mysqli_fetch_assoc($result)){
		$sql = 'insert into transaction_trading_account (invoice_id, entry_date, user_id, child_id, child_value) values("'.$invoice_id.'", "'.date("Y-m-d").'", "'.$_SESSION['usersno'].'", "'.$row['sno'].'", "'.$_POST['child_'.$row['sno']].'")';
