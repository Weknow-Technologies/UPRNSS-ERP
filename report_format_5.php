                ...
                <div class="card">
                    ...
                    <div class="card-body">
						...
						if($_SESSION['usersno']==1){
						    $sql = 'select * from invoice_format_5';
    						...
    						while($row = mysqli_fetch_assoc($result)){
    							...
    							<td><a href="view_format_5.php?id='.$row['sno'].'" target="_blank"><i class="fa fa-eye"></i></a></td></tr>';
    						}
						}
						else{
    						$sql = 'select * from invoice_format_5 WHERE user_id = "'.$_SESSION['usersno'].'"';
    						$result = execute_query($sql);
    						while($row = mysqli_fetch_assoc($result)){
    							echo '<tr>
    							<td>'.$i++.'</td>
