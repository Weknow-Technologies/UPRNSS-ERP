				...
				<tr>
					<td>
						...
						<div class="cont" style="font-weight:bolder;">
							<div><?php if ($arch_data): ?>
									<?php echo $arch_data['full_name_english']; ?> <br> <?php echo $arch_data['address'] ?>
								</div><br>
							<?php endif; ?>
						...
						<div style="margin-left:3rem;text-align:justify;">
							...
							कार्यदायी संस्था नामित किया गया है। उक्त
							निर्माण कार्य के आर्कीटेक्चरल ड्राइंग डिजाइन एवं विस्तृत आगणन / डी०पी०आर० तैयार करने हेतु
						...
						<div class="m-4">
							<ol>
								<li>निर्माण स्थल के निरीक्षण के सर्वे के उपरान्त ही एवं लोक निर्माण विभाग की स्थानीय
									दरों पर डी०पी०आर० तैयार किया जाये।</li>
								...
								<li>
									...
									<?php if ($str_arch_data): ?>
										<b><?php echo $str_arch_data['full_name_english']; ?></b>
									<?php endif; ?>
									स्ट्रक्चरल कन्सल्टेन्ट द्वारा किया जायेगा।
								</li>
								<li>
								...
								<li>उपर्युक्त शर्तों के तहत उल्लिखित निर्माण कार्यों के आर्कीटेक्चरल एवं स्ट्रक्चरल
									ड्राइंग / डिजाइन तथा विस्तृत आगणन / डी०पी०आ० निर्गत आदेश के 15 दिन के अन्दर
									सम्बन्धित प्रखण्ड प्रभारी को देना सुनिश्चित करें।</li>
								<!-- <li>
						...
						<div class="m-4">
							<ol>
								<li><?php
								echo $str_arch_data['full_name_english']; echo $str_arch_data['address']; ?></b>
									को इस निर्देश के साथ कि वे सम्बन्धित वास्तुविद से आर्कीटेक्चरल ड्राइंग, प्राप्त कर
									डिजाइन/ड्राइंग, डिजाइनिंग डिटेल एवं वर्किंग ड्राइंग तैयार करते हुए सम्बन्धित
									वास्तुविद को एक सप्ताह में उपलब्ध करायें एवं मुख्य सचिव, उ०प्र० शासन के निर्देश
									दि0-174. 06. भूकम्परोधी दिशा निर्देश, नेशनल बिल्डिंग कोड 2005 (उ०प्र० डिजास्टर
									मैनेजमेन्ट अथारिटी गाइडलाइन्स) का भी अनुपालन सुनिश्चित करें।
								</li>
								<li>
								...
								<li>
									<b>प्रखण्ड प्रभारी, यूपीआरएनएसएस, निर्माण प्रखण्ड
										<?php echo $project_data['division_name']; ?></b> को इस निर्देश के साथ प्रेषित
									कि
									परियोजना से सम्बन्धित सर्वे एवं कन्दूर प्लान तथा मृदा परीक्षण रिपोर्ट तत्काल
									वास्तुविद तथा स्ट्रक्चरल कन्सल्टेन्ट को उपलब्ध कराना सुनिश्चित करें तथा गहनता से
									अनुश्रवण करते हुए तत्काल डी०पी०आर० को स्वीकृति हेतु मुख्यालय को प्रेषित करें।
								</li>
								<li>
