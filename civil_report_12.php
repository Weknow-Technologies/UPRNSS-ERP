                ...
                <div class="card">
					...
					<table class="table table-hover table-responsive table-striped tablepad " id="">
						<thead style="position:sticky;top:0; z-index:2;">
							<tr>
								<th rowspan="2">क्र्म. स०</th>
								<th rowspan="2">जनपद </th>
								<th rowspan="2">प्रखण्ड का नाम  </th>
								<th rowspan="2">विभाग का नाम</th>
								<th rowspan="2">परियोजना का नाम (हिन्दी )</th>
								<th rowspan="2">शाशनदेश संख्या </th>
								<th rowspan="2">स्वकृत  <br>लागत <br>(रुo लाख मे)</th>
								<th rowspan="2">कार्य  प्रारम्भ की तिथि  </th>
								<th rowspan="2">कार्य  पूर्ण  की तिथि  </th>
								<th rowspan="2">Mpr Date</th>
								<th rowspan="2">कुल प्राप्त धनराशि ( लाख में )</th>
								<th rowspan="2">अब तक का कुल व्यय </th>
								<th rowspan="2">भौतिक प्रगति समग्र </th>
						...
						$i=1;
							if(isset($_POST['search'])){
								...
								while($row = mysqli_fetch_assoc($result)){
									...
									<td rowspan="'.$rowspan.'">'.$row['division_name'].'</td>
									<td rowspan="'.$rowspan.'">'.$row['department_name_hindi'].'</td>
									<td rowspan="'.$rowspan.'">'.$row['project_name_hindi'].'</td>
									<td rowspan="'.$rowspan.'">'.$row['admin_go_no'].'/';if ($row['admin_go_date'] == "") {echo "-";  } else {echo date("d-m-Y", strtotime($row['admin_go_date']));};echo'</td>
									
									<td rowspan="'.$rowspan.'">'.$row['sanction_cost'].'</td>
									
									<td rowspan="'.$rowspan.'">';if ($row['work_start_date'] == "") {echo "-";  } else {echo date("d-m-Y", strtotime($row['work_start_date']));};echo'</td>
									<td rowspan="'.$rowspan.'">';if ($row['work_completion_date'] == "") {echo "-";  } else {echo date("d-m-Y", strtotime($row['work_completion_date']));};echo'</td>
									';
