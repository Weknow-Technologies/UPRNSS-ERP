					...
					<div class="card-body">
						...
						<div class="row border rounded m-2 p-2 border-secondary" id="" >
							...
							<div class="col-md-3">
								...
								<input type="text" class="form-control" name="agrimsamayojan_<?php echo $i; ?>" id="agrimsamayojan_<?php echo $i; ?>" value="<?php echo $_POST['agrimsamayojan_'.$i]; ?>">
							</div>
							<div class="col-md-3">
							...
							<div class="col-md-3">
								...
								<input type="text" class="form-control" name="totel_<?php echo $i; ?>" id="totel_<?php echo $i; ?>" value="<?php echo $_POST['totel_'.$i]; ?>">
							</div>
							<div class="col-md-3">
					...
					<div class="card-body">
						<table class="table table-striped table-bordered table-hover justify-content-center">
							...
							while($row_prarup_new_4 = mysqli_fetch_assoc($result_prarup_new_4)){
								...
								<td><a href="'.$_SERVER["PHP_SELF"].'?edit_sno='.$row_prarup_new_4['sno'].'" target="_blank"><i class="fa fa-eye">edit</i></a></td>
								</tr>';
							}
							?>
							</tbody>
