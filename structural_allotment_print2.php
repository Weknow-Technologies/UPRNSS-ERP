...
<style>
        ...
        .diagonal-line {
            ...
            height: 2px; /* Adjust the height/thickness as needed */
        ...
        @media print {
            ...
            .diagonal-line {
                display: none; /* Hide the diagonal line when printing */
            }
        }
    </style>
<div class="cont">
                ...
                <tr>
                    ...
                    <div class="cont" style="display:flex;justify-content:space-between;">
                        ...
                        <div class="cont" style="font-weight:bolder;">
							<div><?php
                                     echo $str_arch_data['full_name_english']; echo $str_arch_data['address']; ?> </div><br>
                            <div>विषय-स्ट्रक्चरल डिजाइन एवं ड्रॉइंग तैयार करने के सम्बन्ध में। </div>
                        </div>
                        <div style="margin-left:3rem;text-align:justify;">
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; निम्नलिखित निर्माण कार्यों के स्ट्रक्चरल डिजाइन
                            तैयार करने हेतु
                        ...
                        <div class="m-4">
                            <ol>
                                <li>निर्माण स्थल के निरीक्षण से सम्बन्धित पत्रांक क्यू०एफ०/सि०/24 दिनांक 23 जून, 2006 का
                                    अनुपालन अनिवार्यता से किया जाय।
                                </li>
                                <li>कन्सल्टेन्सी का भुगतान निम्न प्रकार से किया जायेगा-
                                    <ol style="margin-left:0.1rem;">
                                        <li>यदि किसी परियोजना का अनुमोदित प्लान ग्राहक विभाग से प्राप्त नहीं होता है
                                            अथवा मानकीकृत नहीं है। तो आर्कीटेक्चरल एवं स्ट्रक्चरल डिजाइन कन्सलटेन्सी
                                            हेतु अधिकतम कुल 1.50% की दर से भुगतान किया जायेगा।
                                            <ol type="I" style="margin-left:0.1rem;">
                                                <li>वास्तुविदीय कन्सल्टेन्सी के अन्तर्गत कराये जाने वाले कार्य (Scope of
                                                    ...
                                                    किया जायेगा।</li>
                                                <li> स्ट्रक्चरल कन्सल्टेन्सी के अन्तर्गत कराये जाने वाले कार्य (Scope of
                                        ...
                                        <li>
                                            ...
                                            कोई भी परिवर्तन नहीं होता है तो आर्कीटेक्चरल ड्राइंग एवं स्ट्रक्चरल डिजाइन
                                            कन्सल्टेन्सी हेतु कुल 1.20% की दर से भुगतान किया जायेगा।
                                            <ol type="I" style="margin-left:0.1rem;">
                                                <li>
                                ...
                                <li> उपरोक्त परियोजना / परियोजनाओं के स्ट्रक्चरल डिजायन एवं ड्राइंग तैयार करने हेतु स्ट्रक्चरल कन्सल्टेन्सी के अन्तर्गत कराये जाने वाले कार्य (Scope of Services) के अनुसार कार्य करने हेतु आपको नामित किया जाता है एवं आप मुख्य सचिव, उ०प्र० शासन के निर्देश दि० 17.04.06, भूकंप्रोशी दिशा स्ट्रक्चरल बिल्डिंग कोड 2005 (उ०प्र० डिजास्टर मैनिज्मन्ट अथॉरिटी गाइडलाइन्स) का भी अनुपालन सुनिश्चित करें। 
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    security. in 3 months within 3 of the completion of curity. This security shall be
                                    released the project. In special circumstances, when the completion is held up, this
                                ...
                                <li>उपर्युक्त शर्तों के तहत उल्लिखित निर्माण कार्यों के आर्कीटेक्चरल ड्राइंग / डिजाइन तथा विस्तृत आगणन / डी०पी०आर० एवं स्ट्रक्चरल ड्रॉइंग किसी राजकीय इंजीनियरिंग कॉलेज से वेट कराकर निर्गत आदेश के एक सप्ताह के अन्दर देना सुनिश्चित करें।
                                </li>                                
                            </ol>
                        </div>
                        <!-- <div style="margin-left:3rem;text-align:justify;">
                        ...
                        <div class="m-4">
                            <ol>
                                <!-- <li>
                                    <b><?php
                                    echo $str_arch_data['full_name_english']; echo $str_arch_data['address']; ?></b>  को मुख्यालय के पत्रांक 2719/क्यू०एफ०/सिविल/टी-172(20) के क्रम मे सूचनार्थ प्रेषित।
                                </li> -->
                                <li>
                                ...
                                <li>
                                    <b>प्रखण्ड प्रभारी, यूपीआरएनएसएस, निर्माण प्रखण्ड
                                        <?php echo $project_data['division_name']; ?></b> को इस निर्देश के साथ प्रेषित की मुख्यालय के पत्रांक 2719/क्यू०एफ०/सिविल/टी-172(20) के द्वारा उनके द्वारा तत्समय किए गए अनुरोश के क्रंम मे उपरोक्त कार्य प्रखण्ड <b><?php echo $project_data['division_name']; ?></b> को आवंटित किया गया था, परंतु वर्तमान मे किए गए उपरोक्त के क्रम मे प्रखण्ड <b><?php echo $project_data['division_name']; ?></b> के स्थान पर प्रखण्ड <b><?php echo $project_data['division_name']; ?></b> को उक्त कार्य आवंटित किया जाता है।  
                                    </li>
                                <li>
                                    सामान्य प्रबन्धक (वित्त), यूपीआरएनएसएस मुख्यालय।
                                </li>
                                <li>
                        ...
                        <p style="text-align:right;font-size:1.1rem;font-weight:bolder"></p>
                    </td>
                </tr>
            </tbody>
            <tfoot valign="bottom">
