            ...
            <div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h4 class="card-title text-center bg-danger text-white p-2">प्रखण्डों द्वारा अभिलेखों में दर्शित / मॉग की जा रही ग्राहक विभाग द्वारा कटौती की गई आयकर की धनराशि का विवरण </h4></br>
					</div>
						<?php echo $msg; ?>
					<div class="card-body">
						<div class="row">
							...
							<div class="form-group">
								...
								<?php 
									if (isset($_GET['edit_sno']) && $_GET['edit_sno'] != "") {
										...
										<a href="prarup_new_8.php" class="btn btn-info">Back</a>';
									}else{
		...
		<div class="row">
            <div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
						<table class="table table-striped table-bordered table-hover" id="general_start_table">
							<thead >
								<tr>
									<th>Sno</th>
									<th>Division</th>
							...
							if($_SESSION['usertype']=="sadmin"){
								$sql = 'SELECT sno,division_id, entry_date, created_by  FROM `invoice_prarup_8`';
							}else{
							...
							while($row_prarup_new_4 = mysqli_fetch_assoc($result_prarup_new_4)){
								...
								<td><a href="'.$_SERVER["PHP_SELF"].'?edit_sno='.$row_prarup_new_4['sno'].'"><span class="far fa-edit" aria-hidden="true" data-toggle="tooltip" title="Edit " ></span>
								</tr>';
							}
							?>
							</tbody>
...
?>
    ...
    $(document).ready(function() {
        ...
        $prarup_7_id = intval($_POST['prarup_8_id']); 
