            ...
            <div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h4 class="card-title text-center bg-danger text-white p-2">मुख्यालय  को सेंटेज प्रेषण का विवरण वर्ष 2023-24</h4></br>
					</div>
                            <?php echo $msg; ?>
					<div class="card-body">
						<div class="row">
							...
							<div class="form-group">
								...
								<?php 
									if (isset($_GET['edit_sno']) && $_GET['edit_sno'] != "") {
										...
										<a href="prarup_new_1.php" class="btn btn-info">Back</a>';
									}else{
					...
					<div class="card-body">
						<table class="table table-striped table-bordered table-hover">
							...
							if($_SESSION['usertype']=="sadmin"){
								$sql = 'SELECT sno,division_id, entry_date, created_by  FROM `invoice_prarup_1` ORDER BY division_id';
							}else{
	...
	<script>
		function addCalc(line_serial) {
			...
			for (let i = 1; i <= id; i++) {
				...
				document.getElementById("remaindey_"+i).value=ans.toFixed(2);
				// console.log(ans);
			}
		}
