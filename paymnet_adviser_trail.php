...
$bill_snos = !empty($note_data['related_bill_snos']) ? $note_data['related_bill_snos'] : '0';
...
<body>
    ...
    <div class="body-text">
        आपकी शाखा में उत्तर प्रदेश राज्य निर्माण सहकारी संघ लि. (यू. पी. आर. एन. एस. एस.), का खाता
        संख्या-<strong><?php echo $ho_bank_row['account_no']; ?></strong> संचालित हैं, अधोलिखित विवरण के अनुसार उनके नाम
        के आगे अंकित धनराशि को उनके खाते में Transfer करने का कष्ट करें।
    </div>
