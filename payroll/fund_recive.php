...
page_sidebar();
	...
	if(isset($_POST['submit'])){
		if($_POST['edit_sno']==''){
		$sql = 'insert into invoice_fund_receive (`fund_receive_type` ,`fund_receive_to` ,`installment` ,`order_no` ,`order_date` ,`receive_date` ,`tot_receive_amount`, tds_per, `tds_deducted`, gst_tds_per , `gsttds_deducted`, labour_sess, `bank_name` ,`account_no` ,`ifsc_code` ,`remark` ,`status` ,`created_by` ,`creation_time` ) 
		
		values ("'.$_POST['fund_receive_type'].'", "'.$_POST['fund_receive_to'].'", "'.$_POST['installment'].'", "'.$_POST['order_no'].'", "'.$_POST['order_date'].'", "'.$_POST['receive_date'].'", "'.$_POST['tot_receive_amount'].'", "'.$_POST['tds_per'].'", "'.$_POST['tds_deducted'].'", "'.$_POST['gst_tds_per'].'", "'.$_POST['gsttds_deducted'].'", "'.$_POST['labour_sess'].'", "'.$_POST['bank_name'].'", "'.$_POST['account_no'].'", "'.$_POST['ifsc_code'].'","'.$_POST['remark'].'", "0","'.$_SESSION['usersno'].'","'.date("Y-m-d H:i:s").'" )';
		execute_query($sql);
		if(mysqli_error($db)){ 
...
if(isset($_GET['del'])){
	$sql = 'delete from invoice_fund_receive where sno="'.$_GET['del'].'"';
	execute_query($sql);
					...
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select name="fund_receive_to" id="fund_receive_to" class="form-control" value="<?php echo $_POST['fund_receive_to']; ?>" tabindex="<?php echo $tab++; ?>">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select name="installment" id="installment" class="form-control"  value="<?php echo $_POST['installment']; ?>" tabindex="<?php echo $tab++; ?>">
						...
						<!--	<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" name="request_no" id="request_no" class="form-control" placeholder="" value="<?php //echo $_POST['request_no']; ?>" tabindex="<?php //echo $tab++; ?>">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									...
									<script  type="text/javascript" language="javascript">
									document.writeln(DateInput('request_date', 'user_form', true, 'YYYY-MM-DD', '<?php echo $_POST['request_date']; ?>', <?php //echo $tab; $tab+=4;?>));
									</script>
								</div>
							</div>-->
						</div>
						...
						<div class="row">
							<!--<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" name="request_amount" id="request_amount" class="form-control" placeholder="" value="<?php //echo $_POST['request_amount']; ?>" tabindex="<?php //echo $tab++; ?>">
								</div>
							</div>-->
							<div class="col-md-4">
								<div class="form-group">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select class="form-control" name="bank_name" id="bank_name"  tabindex="<?php echo $tab++; ?>">
											<option value="">--- Select ---</option>
											<?php
												$query = 'SELECT * FROM ho_bank_details ';
											// echo $query;
											$run = mysqli_query($db,$query);
											while($data = mysqli_fetch_array($run)){
												echo '<option value="'.$data['sno'].'" ';
												...
												echo '>'.trim($data['bank_name']).'-&nbsp;<b><u>'.trim($data['account_no']).'</u></b></option>';
						...
						<div class="row">
							<div class="col-md-1">
								<div class="form-group">
									...
									<input type="text" name="tds_per" id="tds_per" class="form-control" value="<?php echo $_POST['fund_receive_to']; ?>" tabindex="<?php echo $tab++; ?>" onInput="percent_amt_calc()">
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
							...
							<div class="col-md-1">
								<div class="form-group">
									<label>Percentage</label>
									<input type="text" name="gst_tds_per" class="form-control" id="gst_tds_per" value="<?php echo $_POST['fund_receive_to']; ?>" tabindex="<?php echo $tab++; ?>" onInput="percent_amt_calc()">
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
					...
					<!--<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" name="account_no" id="account_no" class="form-control" placeholder="" value="<?php echo $_POST['account_no']; ?>" tabindex="<?php echo $tab++; ?>">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label for="exampleInputEmail1">IFSC Code</label>
									<input type="text" name="ifsc_code" id="ifsc_code" class="form-control" placeholder="" value="<?php echo $_POST['ifsc_code']; ?>" tabindex="<?php echo $tab++; ?>">
								</div>
							</div>
						</div>-->
					...
					<table class="table table-hover table-striped table-bordered">
						...
						<tbody>
							...
							while($row = mysqli_fetch_assoc($result)){	
								...
								<td><a href="fund_recive_details.php?id='.$row['sno'].'" target="_blank">View</a></td>
