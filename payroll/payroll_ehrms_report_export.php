...
$sheet->setCellValue('D3', 'Emp Location');
$sheet->setCellValue('E3', 'EHRMSID');
$sheet->setCellValue('F3', 'Month');
$sheet->setCellValue('G3', 'Year');
$sheet->setCellValue('H3', 'Gross Salary Emp');
$sheet->setCellValue('I3', 'Net Salary Emp');
...
while ($row = mysqli_fetch_array($result)) {
    if ($row['total'] > 0) {
        ...
        $sheet->setCellValue('D' . $row_count, $row_div["division_name"]);
        $sheet->setCellValue('E' . $row_count, $row["ehrms_id"]);
        $sheet->setCellValue('F' . $row_count, $row["for_month"]);
        $sheet->setCellValue('G' . $row_count, $row["financial_year"]);
        $sheet->setCellValue('H' . $row_count, $row["total_income"]);
        $sheet->setCellValue('I' . $row_count, $row["total"]);
