	...
	if(isset($_POST['confirm_submit'])){
		...
		while ($row_employee_attendance = mysqli_fetch_array($result_employee_attendance)) {
			...
			if($num_check == 0){
				...
				"main","'.$_POST['working_days_'.$row_employee_attendance['emp_id'].''].'", "'.$_POST['presented_days_'.$row_employee_attendance['emp_id'].''].'", "'.$_POST['granted_leave_'.$row_employee_attendance['emp_id'].''].'","'.$_POST['company_id'].'", "'.$date_to_store.'" )';
						...
						<table class="table table-hover table-responsive table-bordered table-striped">
							...
							<tr>
									...
									<td>
										...
										<?php 
											$sql_details = 'SELECT * FROM `payroll_emp_category` where sno=4';
							...
							<tr>
								...
								<?php 
									...
									while($row_heads = mysqli_fetch_assoc($result_salary)){
										...
										$basic_value_per= $basic_value*$row_employee['suspended_percentege']/100;
