				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="row border rounded m-2 p-2 border-secondary">
							<div class="col-md-2">
								<label >माह</label>
								<select name="month_<?php echo $i; ?>" id="month_<?php echo $i; ?>" class="form-control"  tabindex="<?php echo $tab++; ?>" required>
							...
							<div class="col-md-3">
								...
								<input type="text" class="form-control" name="gsttdsbhuktan_<?php echo $i; ?>" id="gsttdsbhuktan_<?php echo $i; ?>" value="<?php echo isset($_GET['editid']) ? $editrow['gsttdsbhuktan_'.$i] : ''; ?>">
							</div>
							<div class="col-md-3">
								<label>मुख्यालय को प्रेषित जी०एस०टी० टी०डी०एस० की राशि</label>
								<input type="text" class="form-control" name="gsttdsrashi_<?php echo $i; ?>" id="gsttdsrashi_<?php echo $i; ?>" value="<?php echo isset($_GET['editid']) ? $editrow['gsttdsrashi_'.$i] : ''; ?>">
							</div>
							<div class="col-md-3">
							...
							<div class="col-md-3">
								...
								<input type="text" class="form-control" name="gsttdssno_<?php echo $i; ?>" id="gsttdssno_<?php echo $i; ?>" value="<?php echo isset($_GET['editid']) ? $editrow['gsttdssno_'.$i] : ''; ?>">
							</div>
							<div class="col-md-3">
								<label>अवशेष</label>
								<input type="text" class="form-control" name="avshesh_<?php echo $i; ?>" id="avshesh_<?php echo $i; ?>" value="<?php echo isset($_GET['editid']) ? $editrow['avshesh_'.$i] : ''; ?>">
							</div>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<div class="form-group">
								<button type="submit" name="submit" class="btn btn-success" onClick="return confirm('Are you sure?');">Submit</button>
