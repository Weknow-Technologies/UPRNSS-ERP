						...
						<div class="row">
							<div class="col-md-3 ">
								<div class="form-group">
									...
									<select required class="form-control" name="department" id="department" tabindex="<?php echo $tab++; ?>" onChange="fill_sub_department(this.value), fill_scheme(this.value)">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<select name="project_type" id="project_type" class="form-control" onchange="onchangetype()" readonly>
										<option value="">--- Select ---</option>
						...
						<div class="row" id="admin" style="display:none;" >
							<div class="col-md-3 ">
								<div class="form-group">
									...
									<input required type="text" name="go_number" id="go_number" class="form-control" placeholder=" " value="<?php echo $_POST['go_number']; ?>" <?php echo $tab++; ?>>
								</div>
							</div>
							<div class="col-md-3 ">
								<div class="form-group">
					...
					<div class="card">
						...
						<div class="card-body border rounded m-3 p-2 border-secondary">
							<div class="row " >
								...
								<div class="col-md-6 ">
									<div class="form-group">
										...
										<input required type="text" name="project_name_hindi" id="project_name_hindi" class="form-control" placeholder=" " value="<?php echo $_POST['project_name_hindi']; ?>" tabindex="<?php echo $tab++; ?>">
										</input>
									</div>
								</div>
							</div>	
							<div class="row" >
								<div class="col-md-4">
									<div class="form-group">
										<label> Scheme </label>					
										<select class="form-control" name="scheme" id="scheme" tabindex="<?php echo $tab++; ?>" onChange="fill_sub_scheme(this.value)">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<select class="form-control" name="sub_scheme" id="sub_scheme" tabindex="<?php echo $tab++; ?>"></select>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										...
										<option value="">--Select--	</option>
										<option value="Governance level"<?php echo ($_POST['project_under']=='Governance level'?'selected':''); ?>>Governance level</option>
						...
						<div class="card-body">
								...
								<div id="add_rows_length" class="row">
									<div class="col-md-4 "><?php echo $i; ?>.
										<div class="form-group">
											...
											<select required class="form-control" name="unit_name_<?php echo $i; ?>" id="unit_name_<?php echo $i; ?>" tabindex="<?php echo $tab++; ?>">
												<option value="">--- Select ---</option>
												<?php
									...
									<div class="col-md-4 ">
										<div class="form-group">
											...
											$run = mysqli_query($db,$query);
											?>
											<select required class="form-control" name="district_name_<?php echo $i; ?>" id="district_name_<?php echo $i; ?>"  >
											<option value="">--- Select ---</option>
											<?php
											while($data = mysqli_fetch_array($run))
											{
									...
									<div class="col-md-3 ">
										<div class="form-group">
											...
											<input required type="text" name="project_qun_<?php echo $i; ?>" id="project_qun_<?php echo $i; ?>" class="form-control" placeholder=" " value="<?php echo $_POST['project_qun_'.$i]; ?>" tabindex="<?php echo $tab++; ?>">
										</div>
									</div>
							...
							<div class="col-md-12 pr-1"  align = "center">
								...
								<input type="hidden" name="edit_sno" value="">
								</div>
							</div>
						</div>
					</div>
