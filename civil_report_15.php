            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-danger mt-4">
                        <div style="font-size:1.15rem;text-align:center;text-decoration:underline;" class="text-white">वर्तमान मे संचालित <span class="no-print">शासन स्तर के</span> समस्त परियोजनाओं का प्रगति विवरण</div>
                    </div>
