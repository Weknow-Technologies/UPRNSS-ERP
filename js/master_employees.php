	...
	if($_POST['edit']==''){
		...
		if(mysqli_error($db)){ 
			...
			for($i=1; $i<=$_POST['add_rows_id_work'] &&$_POST['pramotaion_type_'.$i]!='';  $i++){
				$sql = 'insert into employee_appointment (employee_id, appo_id, appointment_no, appointment_date, appoint_division, post, pay_band_id, grade_pay_id, pay_level_id, joinning_date, status, created_by, creation_time) values ("'.$id.'", "'.$_POST['pramotaion_type_'.$i].'", "'.$_POST['order_no_'.$i].'","'.$_POST['order_date_'.$i].'", "'.$_POST['place_'.$i].'","'.$_POST['post_'.$i].'", "'.$_POST['pay_band_id_'.$i].'", "'.$_POST['grade_pay_id_'.$i].'", "'.$_POST['post_'.$i].'", "'.$_POST['joinning_date_'.$i].'", "0", "'.$_SESSION['usersno'].'", "'.date("Y-m-d H:i:s").'")';
				echo $sql;
				execute_query($sql);
				if(mysqli_error($db)){ 
					$msg .= '<p class="text text-danger">Error # 1 : '.mysqli_error($db).'>> '.$sql.'</p>';
				}else{
					$msg .= '<div class="alert alert-danger">Promotation Add </div>';
				}
			}
		}
	}
		...
		attached_check  =   "'.$_FILES['attached_check']['name'].'", 
		...
		if(mysqli_error($db)){ 
			...
			move_uploaded_file ($_FILES['pan_file']['tmp_name'], "master_employees_img/pan/".$_FILES['pan_file']['name']);
			move_uploaded_file ($_FILES['attached_check']['tmp_name'], "master_employees_img/pan/".$_FILES['attached_check']['name']);
			$sql = 'delete from dp_qulification where personal_info_id="'.$id.'"';
			execute_query($sql);
			for($i=1; $i<=$_POST['add_rows_id']; $i++){
				$sql = 'insert into dp_qulification (personal_info_id, class_id, college_name, board_name, roll_number, obtained_marks, percentage, grade, file_name) values ("'.$id.'", "'.$_POST['class_id_'.$i].'","'.$_POST['college_name_'.$i].'", "'.$_POST['board_name_'.$i].'","'.$_POST['roll_number_'.$i].'","'.$_POST['obtained_marks_'.$i].'","'.$_POST['percentage_'.$i].'","'.$_POST['grade_'.$i].'","'.$_FILES['file_name_'.$i]['name'].'")';
				execute_query($sql);
			...
			$sql = 'delete from dp_miscellaneous where personal_info_id="'.$id.'"';
			execute_query($sql);
			for($i=1; $i<=$_POST['add_rows_id1']; $i++){
				$sql = 'insert into dp_miscellaneous (personal_info_id, title, file_name) values ("'.$id.'","'.$_POST['title_'.$i].'", "'.$_FILES['attachment_'.$i]['name'].'")';
				execute_query($sql);
							...
							<div class="col-md-12">
								<div class="card tab" >
									...
									<table width="100%" class="table table-striped-success table-hover rounded">
										...
										<td><select class="form-control" name="employee_designation" id="employee_designation" tabindex="<?php //echo $tab++; ?>">
										<option value="">--- Select ---</option>
										<?php
										...
										<td>Employee Type</td>
										<td>
											<select  name="employee_type" id="employee_type" tabindex="<?php //echo $tab++; ?>" class="form-control">
												<option value="">--Select--</option>
												<?php 
									...
									<!--	<td>Employee Sub-Group</td>
										<td>
											<select  name="employee_subgroup" id="employee_subgroup" tabindex="<?php //echo $tab++; ?>" class="form-control">
												<option value="">--Select--</option>
												<?php 
									...
									<table width="100%" class="table table-striped table-hover rounded">
										...
										<tr>
											<td><input type="file" name="employee_image" class="form-control" tabindex="<?php echo $tab++; ?>" value="<?php if(isset($row['employee_image'])){echo $row['employee_image'];}?>"></td>
											<td></td>
											<td>Aadhar file</td>
											<td><input type="file" name="aadhar_file" class="form-control" tabindex="<?php echo $tab++; ?>" value="<?php if(isset($row['aadhar_file'])){echo $row['aadhar_file'];}?>"></td>
											<td>Pan File</td>
											<td><input type="file" name="pan_file" class="form-control" tabindex="<?php echo $tab++; ?>" value="<?php if(isset($row['pan_file'])){echo $row['pan_file'];}?>"></td>
								...
								<div class="card tab"  >
									...
									<table width="100%" class="table table-striped-success table-hover rounded">
										<tr class="table-danger ">
											...
											<td><input type="file" name="attached_check" class="form-control" tabindex="<?php echo $tab++; ?>" value="<?php if(isset($row['attached_check'])){echo $row['attached_check'];}?>"></td>
										</tr>
										...
										<div id="add_rows_length" class="row">
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<select class="form-control" name="grade_pay_id" id="grade_pay_id" tabindex="<?php echo $tab++; ?>" onchange="onchangetype()" >
													<option value="">--- Select ---</option>
													<?php
									...
									<div class="border rounded m-2 p-2 border-secondary" id="">
										<div id="add_rows_length" class="row">
											...
											<div class="col-md-3">
												<div class="form-group">
													<label >Pay Band</label>
													<select class="form-control" name="pay_band_id_<?php echo $i; ?>" id="pay_band_id_<?php echo $i; ?>" tabindex="<?php echo $tab++; ?>" >
														<option value="">--- Select ---</option>
														<?php
														$query = "select * from master_pay_band";
														$run = mysqli_query($db,$query);
											...
											<div class="col-md-3">
												<div class="form-group">
													<label>Pay Level</label>
													<select class="form-control" name="pay_level_id_<?php echo $i; ?>" id="pay_level_id_<?php echo $i; ?>" tabindex="<?php echo $tab++; ?>" >
													<option value="">--- Select ---</option>
													<?php
													$query = "select * from master_pay_level ";
													$run = mysqli_query($db,$query);
											...
											<div class="col-md-3">
												<div class="form-group">
													<label>Basic Pay</label>
													<select class="form-control" name="grade_pay_id_<?php echo $i; ?>" id="grade_pay_id_<?php echo $i; ?>" tabindex="<?php echo $tab++; ?>" onchange="onchangetype()" >
														<option value="">--- Select ---</option>
														<?php
														$query = "select * from master_pay_level_grade";
														$run = mysqli_query($db,$query);
...
?>
	<script type="text/javascript">
			...
			function add_rows_work(){
				...
				?>
				txt += '</select>';
				txt += '</div></div><div class="col-md-3 "><div class="form-group"><label>Pay Band</label><select class="form-control" name="pay_band_id_'+id+'" id="pay_band_id_'+id+'"  ><option value="">--- Select ---</option>';
				<?php
				$query = 'select * from master_pay_band ';
				$run = mysqli_query($db,$query);
				while($data = mysqli_fetch_array($run)){
				...
				?>
				txt += '</select>';
				txt += '</div></div><div class="col-md-3 "><div class="form-group"><label>Pay Level</label><select class="form-control" name="pay_level_id_'+id+'" id="pay_level_id_'+id+'"  ><option value="">--- Select ---</option>';
				<?php
				$query = 'select * from master_pay_level ';
				$run = mysqli_query($db,$query);
				while($data = mysqli_fetch_array($run)){
