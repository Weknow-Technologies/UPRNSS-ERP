   ...
   <form id="sale_form" name="sale_form" class="" autocomplete="off" enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" onSubmit="">
	...
	<div id="container" class="no-print">	
		<div class="card card-body">    
            ...
            <div class="" style="font-size:1.2rem;text-align:center;font-family:arial;">विगत 02 वर्षों में आवंटित कार्य एवं उसकी प्रगति</div>
					...
					<table class="table table-striped table-hover table-bordered" id="general_stat_table">
						...
						if($_SESSION['usertype']=='sadmin'){
							...
							if(isset($_POST['search'])){
								...
								$sql .= ' and '.$_POST['date_type'].'>="'.$fromdate.'" and '.$_POST['date_type'].'<"'.$todate.'"';
