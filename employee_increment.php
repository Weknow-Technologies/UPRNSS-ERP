            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="bg-danger text-white text-center mt-1">Add Increment</h4></br>
                    </div>
						<?php echo $msg; ?>
                    <div class="card-body ">
                    	<div class="row ">
						...
						<div class="mt-1 pt-1" <?php if(isset($_GET['edit'])){ echo 'style="display:none"';} ?> >
							<h4 class="bg-info text-white text-center mt-1">Last Details</h4>
							<div class="border rounded m-2 p-2 border-secondary" id="">
								<div id="add_rows_length" class="row">
									<div class="col-md-3">
										<div class="form-group">
											<label>Appointment Type</label>
											<select class="form-control" name="appo_id" id="appo_id" tabindex="<?php echo $tab++; ?>" onchange="onchangetype()" readonly>
											<option value="">--- Select ---</option>
											<?php
									...
									<div id="hide" style="display:<?php echo $_POST['appo_id']==5?'flex':'none'; ?>;">
										<div class="col-md-4" >
											<div class="form-group">
												...
												<input type="text" name="deputation_dep_name" id="deputation_dep_name" class="form-control" value="<?php echo $_POST['deputation_dep_name']; ?>" tabindex="<?php echo $tab++; ?>" readonly>
											</div>
										</div>
										<div class="col-md-4"  >
											<div class="form-group">
												<label >Deputation From </label>
											   <input type="date" name="deputation_from" id="deputation_from" class="form-control" value="<?php echo $_POST['deputation_from']; ?>" tabindex="<?php echo $tab++; ?>" readonly>
											</div>
										</div>
										<div class="col-md-4" >
											<div class="form-group">
												<label >Deputation To</label>
											   <input type="date" name="deputation_to" id="deputation_to" class="form-control" value="<?php echo $_POST['deputation_to']; ?>" tabindex="<?php echo $tab++; ?>" readonly>
											</div>
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" name="appointment_no" id="appointment_no" class="form-control" placeholder="" value="<?php echo $_POST['appointment_no']; ?>" tabindex="<?php echo $tab++; ?>" readonly>
										</div>
									</div>
									<div class="col-3">
										<div class="form-group">
											<label >Appointment Date</label>
											<input type="date" name="appointment_date" id="appointment_date" class="form-control" placeholder="" value="<?php echo $_POST['appointment_date']; ?>" tabindex="<?php echo $tab++; ?>" readonly>
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<label >Appoint Division</label>
											<select class="form-control" name="appoint_division" id="appoint_division" tabindex="<?php echo $tab++; ?>" readonly>
											<option value="">--- Select ---</option>
											<?php
									...
									<div class="col-md-3">
										<div class="form-group">
											<label >Post </label>
											<select class="form-control" name="appoint_post" id="appoint_post" tabindex="<?php echo $tab++; ?>" readonly>
											<option value="">--- Select ---</option>
											<?php
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<select name="pay_scale" id="pay_scale" class="form-control" onChange="fill_payband(this.value, 'pay_band_id')" tabindex="<?php echo $tab++; ?>" readonly>
												<option value="">--- Select ---</option>
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<select class="form-control" name="pay_band_id" id="pay_band_id" onChange="fill_paylevel(this.value, 'pay_level_id')" tabindex="<?php echo $tab++; ?>" readonly>
											<option value="">--- Select ---</option>
												<?php
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<select class="form-control" name="pay_level_id" id="pay_level_id" onChange="fill_basicpay(this.value, 'grade_pay_id')" tabindex="<?php echo $tab++; ?>" readonly>
											<option value="">--- Select ---</option>
											<?php
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<select class="form-control" name="grade_pay_id" id="grade_pay_id" tabindex="<?php echo $tab++; ?>" readonly>
											<option value="">--- Select ---</option>
											<?php
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="date" name="joinning_date" id="joinning_date" class="form-control" placeholder="" value="<?php echo $_POST['joinning_date']; ?>" tabindex="<?php echo $tab++; ?>" readonly>
										</div>
									</div>
								</div>
							</div>
					...
					<table class="table table-striped table-hover table-bordered" id="general_stat_table">
						...
						<?php
								...
								if($_SESSION['usertype']=="sadmin"){
									$sql ='select * from employee_appointment where appo_id=9 ';
								}else{
									$sql ='select * from employee_appointment where appo_id=9 and created_by="'.$_SESSION['usersno'].'"';
								}
