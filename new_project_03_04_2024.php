...
if(isset($_POST['department'])){
	...
	if(mysqli_error($db)){ 
		...
		if($msg==''){
			...
			$msg .= '<div class="alert alert-success">Successfully Added '.$times.' New project  </div>';
			// exit();
		}
	}
						...
						<div class="row">
							<div class="col-md-3 ">
								<div class="form-group">
									...
									<select required class="form-control" name="department" id="department" tabindex="<?php echo $tab++; ?>" onChange="fill_sub_department(this.value)">
