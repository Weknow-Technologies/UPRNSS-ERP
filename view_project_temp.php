...
if(isset($_GET['id'])){
	...
	$_POST['architect'] =  $row['architect_id'];
	$_POST['structural_architect'] = $row['structural_architect_id'];
	$_POST['soil_testing_status'] =  $row['soil_testing_status'];
	$_POST['estimation_formation_status'] = $row['estimation_formation_status'];
	$_POST['project_status_1'] = $row['project_status_1'];
	$_POST['project_status_2'] = $row['project_status_2'];
	...
	$_POST['revised_estimate_amount_1'] = $row['revised_estimate_amount'];
	$_POST['revised_estimate_date_1'] = $row['revised_estimate_date'];
	$_POST['revised_dispatch_status_1'] = $row['revised_dispatch_status'];
	$_POST['revised_remittance_amount_1'] = $row['revised_remittance_amount'];
	$_POST['revised_remittance_date_1'] = $row['revised_remittance_date'];
	
	$_POST['add_rows_id'] = 1;
	$_POST['add_rows_id1'] = 1;
	$i=1;
	
	$_POST['project_work_'.$i] = '';
	$_POST['project_work_start_date_'.$i] = '';
	$_POST['scheduled_date_'.$i] = '';
	$_POST['physical_details_'.$i] = '';
	$_POST['progress_last_month_'.$i] = '';
	$_POST['progress_current_month_'.$i] = '';
	$_POST['progress_pert_chart_'.$i] = '';
	$_POST['remark_'.$i] = '';
	
	$_POST['received_amount_'.$i] = '';
	$_POST['installment_'.$i] = '';
	$_POST['month_'.$i] = '';
	$_POST['date_from_'.$i] = '';
                ...
                <div class="card border-primary">
                        ...
                        <div class="row">
							...
							<div class="col-md-3">
                                <div class="form-group">
                                   ...
                                   <input readonly type="text" name="remark" id="remark" class="form-control" placeholder="" value="<?php echo $_POST['remark']; ?>" tabindex="<?php echo $tab++; ?>">
                                </div>
                            </div>
                        </div>
					...
					<br><h4 class="card-title">पुनरीक्षित आगणन  का विवरण </h4></br>
						<div class="row " id="" >
							<div class="col-md-5">
								<div class="form-group">
									<label>पुनरीक्षित आगण की लागत ( लाख में ) </label>
									<input readonly type="text" name="revised_estimate_amount_1" id="revised_estimate_amount_1" class="form-control" placeholder=" " value="<?php echo $_POST['revised_estimate_amount_1']; ?>" tabindex="<?php echo $tab++; ?>">
								</div>
							</div>
							<div class="col-md-5">
								<div class="form-group">
									<label>पुनरीक्षित आगण की तिथि </label>
									<input readonly type="date" name="revised_estimate_date_1" id="revised_estimate_date_1" class="form-control" placeholder="" value="<?php echo $_POST['revised_estimate_date_1']; ?>" tabindex="<?php echo $tab++; ?>">
								</div>
							</div>
						...
						<div class="row " id="" >
							<div class="col-md-4">
								<div class="form-group"> 
									...
									<input readonly type="text" name="revised_dispatch_status_1" id="revised_dispatch_status_1" class="form-control" placeholder=" " value="<?php echo $_POST['revised_dispatch_status_1']; ?>" tabindex="<?php echo $tab++; ?>">
								</div>
							</div>
							<div class="col-md-4 ">
								<div class="form-group">
									<label>धनराशि ( लाख में )</label>
									<input readonly type="text" name="revised_remittance_amount_1" id="revised_remittance_amount_1" class="form-control" placeholder=" " value="<?php echo $_POST['revised_remittance_amount_1']; ?>" tabindex="<?php echo $tab++; ?>">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label>पुनरीक्षित प्रेषण की तिथि </label>
									<input readonly type="date" name="revised_remittance_date_1" id="revised_remittance_date_1" class="form-control" placeholder="" value="<?php echo $_POST['revised_remittance_date_1']; ?>" tabindex="<?php echo $tab++; ?>">
								</div>
							</div>
							<!--- <div class="col-md-1 d-flex justify-content- align-items-center">
						...
						<div class="row border rounded m-2 p-2 border-secondary" id="add_rows_length">
                           <?php echo $i; ?>.
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label >वर्तमान माह तक भौतिक प्रगति (प्रतिशत में )  </label><br>
						...
						for($i=1;$i<=$_POST['add_rows_id1'];$i++){
							$tot_rcpt +=(int) $_POST['received_amount_'.$i]
						?>
