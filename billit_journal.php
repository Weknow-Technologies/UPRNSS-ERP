				...
				<div class="legend" id="legend_container">
						<div class="row" id="row_1">
							...
							<div class="col-md-3 mb-2">
								...
								<input type="text" name="description_1" id="header_description" class="form-control"
		...
		<div class="card">
			<div class="row p-2">
				<div class="col-12 text-right">
					<a href="billit_journal.php"><button type="button" class="btn btn-warning">Create Vouchers (Journal Entry)</button></a>
				</div>
			</div>
		</div>
		<div class="card">
