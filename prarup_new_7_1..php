					...
					<div class="card-body">
						<table class="table table-striped table-bordered table-hover">
							...
							while($row_prarup_new_4 = mysqli_fetch_assoc($result_prarup_new_4)){
								...
								<td><a href="'.$_SERVER["PHP_SELF"].'?edit_sno='.$row_prarup_new_4['sno'].'" target="_blank"><span class="far fa-edit" aria-hidden="true" data-toggle="tooltip" title="Edit " ></span></a></td>
