		...
		<div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
					<table class="table table-striped table-hover table-bordered" id="" border="1">
						...
						<tr>
							...
							<th colspan="3">अवशेष  अप्राप्त धनराशि  </th>
							<th rowspan="2" > अभुक्ति  </th>
							
						
						</tr>
						<tr style="border:1px solid white!important;">
							
							<th>योजना की अवशेष   </th>
							<th> जी. एस. टी. मद </th>
							<th>कुल प्राप्त होने वाली धनराशि  </th>
						...
						$i=1;
							if(isset($_POST['search'])){
								...
								while($row = mysqli_fetch_assoc($result)){
									...
									echo '<tr>
									<td class="no-print"><input type="checkbox"  name="print_sno_'.$row['sno'].'" id="date_of_acceptance_revised_cost" class="form-control" value="'.$row['sno'].'" tabindex=""></td>
									<td>'.$i++.'</td>
									...
									<td>'.$row_invoice['sanction_cost'].'</td>';
									// echo $rcpt_txt;
									echo '
									<td>'.$tot_rcpt.'</td>
									<td>'.round((float)$row_invoice['sanction_cost'] - (float)$tot_rcpt, 2).'</td>
