...
?>
            ...
            <div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
						...
						<?php } ?>
						<input type="hidden" name="prarup_2_id" id="prarup_2_id" value="1">
	...
	function addCalc(line_serial) {
		...
		for (let i = 1; i <= id; i++) {
			...
			document.getElementById("avsheshvyaj_"+i).value=ans;
			// console.log(ans);
		}
	}
	...
	function prarup_2_add_rows(){
		...
		var txt='<div class="row border rounded m-2 p-2 border-secondary" id=""><div class="col-md-3"><label >माह</label>
		<select name="month_'+id+'" id="month_'+id+'" class="form-control"  value="" tabindex=""><option value="Select">Select--</option>
		...
		<div class="col-md-3"><label>ब्याज की दर </label><input type="text" class="form-control" name="rate_'+id+'" id="rate_'+id+'" value="" ></div><div class="col-md-3"><label>प्रारम्भिक अवशेष 01.04. 2023 </label><input onInput="addCalc()" type="text" class="form-control" name="startingavshesh_'+id+'" id="startingavshesh_'+id+'" value="" ></div>
