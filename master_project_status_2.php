...
if(isset($_POST['submit'])){
	if($_POST['edit_sno']==''){
		$sql = 'insert into master_projoect_status_2 (status_2) values ("'.$_POST['status_2'].'")';
		execute_query($sql);
		if(mysqli_error($db)){ 
		...
		$sql = 'update master_projoect_status_2 set 
...
if(isset($_GET['edit_sno'])){
	$sql = 'select * from master_projoect_status_2 where sno="'.$_GET['edit_sno'].'"';
	$data = mysqli_fetch_assoc(execute_query($sql));
	$_POST['edit_sno'] = $data['sno'];
	$_POST['status_2'] = $data['status_2'];
}	

if(isset($_GET['del'])){
	$sql = 'delete from master_projoect_status_2 where sno="'.$_GET['del'].'"';
	execute_query($sql);
						...
						<div class="row" id="">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label > Status Tittle 2</label><br>
                                    <input type="text" name="status_2" id="status_2" class="form-control" placeholder="" value="<?php echo $_POST['status_2']; ?>" tabindex="<?php echo $tab++; ?>">
                                </div>
                            </div>
                        </div>
						<div id="test"></div>
            ...
            <div class="col-md-12">
                <div class="card">
					...
					<table class="table table-striped table-hover">
						...
						<th>S.No.</th>
						<th>Status Tittle 2</th>
						<th></th>
						<th></th>
						</tr>
						<?php
						$i=1;
						$sql = 'select * from master_projoect_status_2 ';
