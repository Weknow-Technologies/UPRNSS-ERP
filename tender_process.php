					...
					<div class="card strpied-tabled-with-hover">
						<div class="card-header text-right">
							<div class="ml-auto no-print">
								<a href="tender_alloted_report.php" class="text-right" target=""><u><i class="icon fas fa-file-alt" aria-hidden="true"></i> Alloted Report</u></a>
							</div>
						</div>
									...
									<?php
										...
										while($row = mysqli_fetch_assoc($result)){	
												...
												<td class="no-print text-center">
													<a href="create_tender.php?id='.$row['sno'].'" onClick="return confirm(\'Are you sure you?\');">नामित<span class="far fa-edit" aria-hidden="true" data-toggle="tooltip" title=""></span></a>
												</td>
